  ...
  return (
    <div className="min-w-[455px] w-[600px] h-fit bg-white rounded-2xl p-8 flex flex-col justify-between">
      <div className="flex flex-col w-full gap-[28px]">
        <div>
          <div className="w-full flex justify-between items-center gap-5 shrink-0 font-semibold text-xl text-primary-900 h-9">
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <div className="relative w-full rounded-xl">
            <table className="w-full outline-primary-900-light outline outline-1 rounded-xl">
        ...
        <div className="relative">
          <input
            ...
            value={message}
            maxLength={45}
            className="w-full h-[45px] border-1 border-secondary-700 rounded-xl px-[17px] font-medium focus:border-primary-900 focus:outline-none focus:border-1 pr-[80px] text-sm"
          />
